 ...
 */
public class About_appController implements Initializable {
        ...
        // TODO
         ...
         TranslateTransition tr = new TranslateTransition();
           ...
           tr.setAutoReverse(true);
             ...
             tr1.setNode(text_pane);
             tr1.setAutoReverse(true);
             tr1.setDuration(Duration.millis(1500));
             tr1.setCycleCount(Animation.INDEFINITE);
           tr1.setAutoReverse(true);
              tr1.setByY(160);
             tr1.setByY(15);
    ...
    void MouseOutBack(MouseEvent event) {
      ...
      @FXML
    void nextMove(MouseEvent e) throws IOException {
