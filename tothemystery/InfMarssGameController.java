...
public class InfMarssGameController implements Initializable {
    ...
    void moveScene(ActionEvent e) throws IOException{
        ...
        loader.setLocation(getClass().getResource("mars.fxml"));
       
        Parent mars_parent = loader.load();
        Scene mars_Scene=new Scene(mars_parent); 
        
        Mars controller = loader.getController();//to get the controller
