...
public class InfUarnusGameController implements Initializable {
    ...
    void moveScene(ActionEvent e) throws IOException{
        ...
        loader.setLocation(getClass().getResource("Uranus.fxml"));
       
        Parent Uranus_parent = loader.load();
        Scene Uranus_Scene=new Scene(Uranus_parent); 
        
        Uranus controller = loader.getController();//to get the controller
        controller.player(currentUser);

     Stage window = (Stage)((Node)e.getSource()).getScene().getWindow();
     
     window.setScene(Uranus_Scene);
    }
