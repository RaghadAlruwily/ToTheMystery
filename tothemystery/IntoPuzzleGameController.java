...
public class IntoPuzzleGameController implements Initializable {
    ...
    void moveScene(ActionEvent e) throws IOException{
        ...
        ImageController controller = loader.getController();//to get the controller
    ...
    public void initialize(URL url, ResourceBundle rb) {
        String addwor = "You must arrange the rocket parts in the exact location of each part "
                      + " using the mouse to move the rocket  "
                      +" parts ";
