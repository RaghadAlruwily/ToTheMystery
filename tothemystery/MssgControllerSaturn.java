...
public class MssgControllerSaturn implements Initializable {
   ...
   FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("infoosaturn.fxml"));
       
        Parent mssM_parent = null;
            try {
                mssM_parent = loader.load();
            } catch (IOException ex) {
                Logger.getLogger(MssgControllerSaturn.class.getName()).log(Level.SEVERE, null, ex);
            }
        Scene mssM_Scene=new Scene(mssM_parent); 
        
       InfooControllerSaturn controller = loader.getController();//to get the controller
