...
public class MssgControllerUranus implements Initializable {
   ...
   private Stage stage1;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        loader.setLocation(getClass().getResource("infoo_Uranus.fxml"));
       
        Parent mssM_parent = null;
            try {
                mssM_parent = loader.load();
            } catch (IOException ex) {
                Logger.getLogger(MssgControllerUranus.class.getName()).log(Level.SEVERE, null, ex);
            }
        Scene mssM_Scene=new Scene(mssM_parent); 
        
       InfooControllerUranus controller = loader.getController();//to get the controller
