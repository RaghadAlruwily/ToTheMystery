...
public class Ssaturn implements Initializable {
    ...
    villian.remove(i);
        ...
        Parent menuParent = null;
                      try {
                          ...
                          Logger.getLogger(Ssaturn.class.getName()).log(Level.SEVERE, null, ex);
                      }
 ...
 rocketwin.setOnMouseClicked(eh->{
   ...
   FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("winsaturn.fxml"));
       ...
       WinControllerSaturn controller = loader.getController();//to get the controller
        controller.player(currentUser);
