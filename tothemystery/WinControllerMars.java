 ...
 * @author blacks
 */
public class WinControllerMars implements Initializable {
  ...
  // player.play();
   ...
   FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("mssgmars.fxml"));
        ...
        MssgControllerMars controller = loader.getController();//to get the controller
